...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: It recieved Sue when it was expecting Bob
    // The PersonQueues class acted like a stack instead of a queue. I changed it so it added an item to the end of the list instead of the beginning.
    ...
    //The test wouldn't check if the turn number was equal or less than 0 so it wouldn't infinitely repeat.
